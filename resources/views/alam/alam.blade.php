            ...
            <div class="grid-item alam" data-category="alam">
                ...
                <div class="box-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('alam.edit', $item->id) }}" class="btn btn-sm btn-info shadow mx-1">Edit</a>
                        <form class="mx-1" onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('alam.destroy'. $item->id) }}" method="post">
                            @csrf
                            @method('DELETE')
